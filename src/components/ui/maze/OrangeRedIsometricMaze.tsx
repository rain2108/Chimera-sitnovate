...
const OrangeRedIsometricMaze: React.FC = () => {
    ...
    const d = () => {
      ...
      for (let y = -h; y < h; y++) {
        for (let i = -g; i < g; i++) {
          ...
          l.addColorStop(0, "rgba(255,100,0,0.9)") // Bright orange
          l.addColorStop(1, "rgba(255,0,0,0.9)") // Bright red
          x.fillStyle = l
          x.fill()
          x.strokeStyle = "rgba(255,200,0,0.8)" // Bright yellow-orange
          x.stroke()
...
export default OrangeRedIsometricMaze
